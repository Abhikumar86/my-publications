...
```{r 2-authcol, fig.height=8, fig.width=8, fig.cap="Collaboration network of first 25 authors from the selected studies. The size of each vertex is proportional to its degree (i.e. the frequency of authors appearance)"}
...
```{r 2-keyocc, fig.height=8, fig.width=8, fig.cap="Co-occurrence network of keywords (n = 25). The size of each vertex is proportional to its degree (i.e. the frequency of keywords)"}
# keywords
...
net <- networkPlot(NetMatrix, normalize="association", weighted=T, 
			 n = 30, Title = NA, type = "fruchterman", 
			 # labels
...
knitr::kable(results$MostCitedPapers[1:10,], digits = 2)
```
