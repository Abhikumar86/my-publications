...
grViz("digraph G{
	...
	node[label='Scopus\n(n = 1,876)', shape=box, width=1.25, fillcolor=grey95]searching_A;
	...
	searching_C -> screening_1[minlen=2]
	screening_1 -> screening_2 -> screening_3 -> screening_4 -> screening_5
			}
			
	node[label='Duplicates \n (n = 717)', shape=box, width=2,style=filled,fillcolor=seashell]screening_a
	node[label='Excluded titles \n (n = 1,796)', shape=box, width=2,style=filled,fillcolor=seashell]screening_b
	node[label='Excluded abstracts \n (n = 264)', shape=box, width=2,style=filled,fillcolor=seashell]screening_c
	node[label='Unretrievable full text \n (n = 11)', shape=box, width=2,style=filled,fillcolor=seashell]screening_d
	node[label='Excluded articles \n (n = 71)', shape=box, width=2,style=filled,fillcolor=seashell]screening_e
